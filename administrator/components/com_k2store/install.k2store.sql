...
CREATE TABLE IF NOT EXISTS `#__k2store_orders` (
  ...
  `order_surcharge` decimal(15,8) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `#__k2store_ordershippings` (
...
CREATE TABLE IF NOT EXISTS `#__k2store_weights` (
...
INSERT IGNORE INTO `#__k2store_weights` (`weight_class_id`, `weight_title`, `weight_unit`, `weight_value`, `state`) VALUES
    (1, 'Kilogram', 'kg', 1.00000000, 1),
    (2, 'Gram', 'g', 1000.00000000, 1),
    (3, 'Ounce', 'oz', 35.27400000, 1),
    (4, 'Pound', 'LB', 2.20462, 1);    

CREATE TABLE IF NOT EXISTS `#__k2store_lengths` (
...
INSERT IGNORE INTO `#__k2store_lengths` (`length_class_id`, `length_title`, `length_unit`, `length_value`, `state`) VALUES
    (1, 'Centimetre', 'cm', 1.00000000, 1),
    (2, 'Inch', 'in', 0.39370000, 1),
    (3, 'Millimetre', 'mm', 10.00000000, 1);
    
CREATE TABLE IF NOT EXISTS `#__k2store_products` (
...
CREATE TABLE IF NOT EXISTS `#__k2store_field` (
...
--
-- Dumping data for table `k2_k2store_field`
--
...
-- insert data for countries table --
			...
			INSERT IGNORE INTO `#__k2store_countries` (`country_id`, `country_name`, `country_isocode_2`, `country_isocode_3`, `state`) VALUES
			...
			INSERT IGNORE INTO `#__k2store_zones` (`zone_id`, `country_id`, `zone_code`, `zone_name`, `state`) VALUES

...
if ( !class_exists( 'K2StoreReportPlugin' ) )
{
	class K2StoreReportPlugin extends K2StorePluginBase
	{
		/**
		...
		public function onK2StoreGetReportView($row){
			if ( !$this->_isMe( $row ) )
			{
				return null;
			}
		 ...
		 */
		public function onK2StoreGetReportPlugins( $element )
		{
			$success = false;
		...
		protected function _getNamespace( )
		{
			...
			$ns = $app->getName( ) . '::' . 'com.k2store.report.' . $this->get( '_element' );
		}
